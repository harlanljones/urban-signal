...
### Added
- Auto-generated deep-dive pages and machine-readable JSON twins for 3 additional metros: Houston (arcgis 311, `CREATED_ON`), Indianapolis (arcgis 311, `REQUESTEDDATETIME`), and Wichita (arcgis permits, `ApplicationDate`) — bringing total to 30 registered metros and 40 sitemap URLs.
