...
# gpsx/gpsy, expressed in Massachusetts Mainland State Plane US survey feet
# (EPSG:2249), not WGS84 degrees.
#
# Resolution (US-137 Path A): transform gpsx/gpsy from Massachusetts Mainland
# State Plane meters (EPSG:26986) to WGS84 at parse time. This preserves the
# source's own geocodes without invoking the slower ADR-0004 address fallback.
#
# Column spellings are pinned by the live CKAN schema probe and contract tests.
# ---------------------------------------------------------------------------
