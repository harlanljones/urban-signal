...
SPINE_INVARIANTS = {
    "src/config.py": ["endpoints declared in settings", "feed topics map to configured topics"],
    "src/spatial/city_registry.py": [
        "alias closure",
        "dataset specs complete",
        "job names unique",
        "get_dataset readable errors",
    ],
    "src/spatial/cities/__init__.py": ["package exports match registry"],
    "src/spatial/geo_utils.py": ["division bboxes nest inside metro", "submarkets inside own division"],
    "src/spatial/submarkets.py": ["submarket borough resolves", "division rosters reference declared submarkets"],
    "src/producers/scheduler.py": ["producer keys resolve", "platform clients exposed"],
    "src/producers/dob_permits_producer.py": ["producer keys resolve", "dataset specs complete"],
    "src/producers/complaints_311_producer.py": ["producer keys resolve", "dataset specs complete"],
    "src/producers/sla_licenses_producer.py": ["producer keys resolve", "dataset specs complete"],
    "src/producers/deeds_acris_producer.py": ["producer keys resolve", "dataset specs complete"],
}
