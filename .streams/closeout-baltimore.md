...
- **Spine files I will not edit:** registry/config/city exports, producer implementations, dashboard sources, README coverage table, and `apps/dashboard/public/index.html`; report exact required patches to the parent interlock instead.
...
- 2026-08-23 — Codebase graph generation is current and reports no parse-partial/skipped files for the relied-on source; `apps/dashboard/public/index.html` remains intentionally excluded and was inspected directly.
