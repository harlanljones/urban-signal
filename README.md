...
| Norfolk (5 Divisions) | DOWNTOWN_WATERFRONT, GHENT_WESTBURG, OCEAN_VIEW, CENTRAL_MILITARY_CIRCLE, SOUTH_NORFOLK_BERKLEY | Socrata | Socrata (geocoded fallback) | — Socrata (now geocoded 96%; pending US-133) | Socrata (FY sales; rotate ID each July) |
...
| Cincinnati (1 Division) | CINCINNATI_CORE | [Socrata](docs/research/socrata-sweep.md#cincinnati) | [Socrata](docs/research/socrata-sweep.md#cincinnati) | [Socrata](docs/research/socrata-sweep.md#cincinnati) | — CSV (Hamilton County; pending US-126) |
...
| Baltimore (1 Division) | BALTIMORE_CORE | ArcGIS | ArcGIS (year-sliced) | ArcGIS (notifications-grade) | — SDAT (pending US-128) |
| Montgomery County, MD (1 Division) | MONTGOMERY_CORE | [Socrata](docs/research/socrata-sweep.md#montgomery-county-md--data-montgomerycountymdgov--2-solid--1-weak) | — MC311 excluded: no coordinates | [Socrata](docs/research/socrata-sweep.md#montgomery-county-md--data-montgomerycountymdgov--2-solid--1-weak) | — SDAT (pending US-128) |
...
| Prince George's County, MD (1 Division) | PRINCE_GEORGES_CORE | — parcel table held | Socrata | — no open endpoint | — SDAT point substitute (pending US-128) |
| Columbus (1 Division) | COLUMBUS_CORE | ArcGIS (Accela schema) | — no open endpoint | — no open endpoint | — ArcGIS (Franklin County; pending US-127) |
| Nashville / Davidson County (1 Division) | NASHVILLE_CORE | ArcGIS (issued) | — hubNashville (now 2026 rows; pending US-131) | ArcGIS (Residential STR) | — no verified sales feed |
| Kansas City (1 Division) | KANSAS_CITY_CORE | — no open endpoint | Socrata | — Socrata (now geocoded; pending US-134) | — no verified sales feed |
...
| Minneapolis (6 Divisions) | MINNEAPOLIS_CORE, CALHOUN_ISLES, CAMDEN_UPPER_NORTH, NORTHEAST, SOUTHEAST_UNIVERSITY, SOUTH_SOUTHWEST | ArcGIS | ArcGIS (year-sliced) | — no open endpoint (stale city layer; defer) | — ArcGIS (On/Off Sale liquor; pending US-135) |
...
| Pittsburgh (1 Division) | PITTSBURGH_CORE | [CKAN](docs/research/socrata-sweep.md#skipped-and-dead-ends) (WPRDC PLI) | — CKAN (new geocoded dataset; pending US-132) | — business-activity licenses (66.9% addressed; defer) | — CKAN (WPRDC sales, price-bearing; pending US-129) |
| San Diego (6 Divisions) | CENTRAL_SAN_DIEGO, COASTAL, CORONA_NORTH_COUNTY, EAST_COUNTY_SAN_DIEGO, MID_CITY, SOUTH_BAY | CSV (Development Services approvals) | — CSV (Get It Done; pending US-124) | — CSV (Business Tax; pending US-125) | — no open endpoint |
